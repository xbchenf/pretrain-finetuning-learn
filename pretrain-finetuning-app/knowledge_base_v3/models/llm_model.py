...
embedding_model_dict = {
    ...
    #"baaibge": "BAAI/bge-large-zh-v1.5",
    "text2vec3": "/root/autodl-tmp/model/text2vec-base-chinese",
...
def get_chatglm3_6b_model(model_path=keys.Keys.CHATGLM3_MODEL_PATH):
    MODEL_PATH = "/root/autodl-tmp/model/chatglm3-6b-sft" #"THUDM/chatglm3-6b";#os.environ.get('MODEL_PATH', model_path)
    llm = chatglm3()
